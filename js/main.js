(function () {
  ...
  /* RSVP form                                                            */
  /*                                                                      */
  /* Sends the form to Formspree (https://formspree.io), a free service   */
  /* that lets a static site receive form submissions by email without    */
  /* any backend code. To activate it:                                    */
  /*   1. Create a free account at https://formspree.io                   */
  /*   2. Create a new form and copy its endpoint, e.g.                   */
  /*      https://formspree.io/f/abcdwxyz                                 */
  /*   3. Paste it below, replacing FORMSPREE_ENDPOINT's value.           */
  ...
  if (rsvpForm) {
    rsvpForm.addEventListener("submit", function (e) {
      ...
      if (FORMSPREE_ENDPOINT.indexOf("REPLACE_ME") !== -1) {
        ...
        rsvpNote.textContent = "El formulario todavía no está conectado — sigue las instrucciones del README para activarlo.";
        return;
      }
